...
class ApiService {
  ...
  Future<String> registerUser(String password, String email) async {
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        print(
          'ApiService Error: Registration failed: ${response.statusCode} - ${errorBody['message']}',
        );
      ...
      throw Exception(
        'Network error or invalid response during registration: $e',
      );
    }
  }
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (token != null) {
          ...
          throw Exception(
            'Login successful but token or userId missing from response.',
          );
        }
      } else {
        final errorBody = json.decode(response.body);
        print(
          'ApiService Error: Login failed: ${response.statusCode} - ${errorBody['message']}',
        );
  ...
  Future<List<Profile>> fetchProfiles() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final errorBody = json.decode(response.body);
        print(
          'ApiService Error: Fetching profiles failed: ${response.statusCode} - ${errorBody['message']}',
        );
      ...
      throw Exception(
        'Network error or invalid response during fetch profiles: $e',
      );
    }
  }
  ...
  Future<Profile> addProfile(Profile profile) async {
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        final errorBody = json.decode(response.body);
        print(
          'ApiService Error: Adding profile failed: ${response.statusCode} - ${errorBody['message']}',
        );
      ...
      throw Exception(
        'Network error or invalid response during add profile: $e',
      );
    }
  }
  ...
  Future<void> deleteProfile(int profileId) async {
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 204) {
        ...
        final errorBody = json.decode(response.body);
        print(
          'ApiService Error: Deleting profile failed: ${response.statusCode} - ${errorBody['message']}',
        );
      ...
      throw Exception(
        'Network error or invalid response during delete profile: $e',
      );
    }
  }
  ...
  Future<List<Category>> fetchCategories(int profileId) async {
    ...
    final url = Uri.parse(
      '${AppStrings.baseUrl}/categories/profile/${profileId.toString()}',
    );
    try {
      final response = await http.get(url, headers: _getHeaders());
      ...
      if (response.statusCode == 200) {
        ...
        final errorBody = json.decode(response.body);
        print(
          'ApiService Error: Fetching categories failed: ${response.statusCode} - ${errorBody['message']}',
        );
      ...
      throw Exception(
        'Network error or invalid response during fetch categoriees: $e',
      );
    }
  }
  ...
  Future<void> addCategory(
    ...
    print(_authToken);
    final url = Uri.parse(
      '${AppStrings.baseUrl}/categories/profile/$profileId',
    );
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        final errorBody = json.decode(response.body);
        print(
          'ApiService Error: Adding category failed: ${response.statusCode} - ${errorBody['message']}',
        );
      ...
      throw Exception(
        'Network error or invalid response during add category: $e',
      );
    }
  }
  ...
  Future<void> deleteCategory(int profileId, int categoryId) async {
    print(
      'ApiService: Deleting category $categoryId from profile $profileId...',
    );
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 204) {
        ...
        final errorBody = json.decode(response.body);
        print(
          'ApiService Error: Deleting category failed: ${response.statusCode} - ${errorBody['message']}',
        );
      ...
      throw Exception(
        'Network error or invalid response during delete category: $e',
      );
    }
  }
  ...
  Future<void> editCategory(
    ...
    if (newImageFile != null) {
      ...
      print(
        'ApiService: Editing category with new image file: ${newImageFile.name}',
      );
    } else {
      request.fields['imageUrl'] =
          currentImageUrl ??
          'https://placehold.co/150x150/CCCCCC/000000?text=Category';
      print(
        'ApiService: Editing category without a new image, using current URL.',
      );
    }
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 204) {
        ...
        final errorBody = json.decode(response.body);
        print(
          'ApiService Error: Editing category failed: ${response.statusCode} - ${errorBody['message']}',
        );
      ...
      throw Exception(
        'Network error or invalid response during edit category: $e',
      );
    }
  }
  ...
  Future<void> addItemToCategory(
    ...
    print(
      'ApiService: Adding item ${word} to category $categoryId for profile $profileId...',
    );
    final url = Uri.parse(
      '${AppStrings.baseUrl}/imagewords/category/$categoryId',
    );
    ...
    if (imageFile != null) {
      ...
      request.fields['imageUrl'] =
          'https://placehold.co/100x100/CCCCCC/000000?text=Item';
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        final errorBody = json.decode(response.body);
        print(
          'ApiService Error: Adding item failed: ${response.statusCode} - ${errorBody['message']}',
        );
  ...
  Future<void> deleteItemFromCategory(
    ...
    print(
      'ApiService: Deleting item $itemId from category $categoryId for profile $profileId...',
    );
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 204) {
        ...
        final errorBody = json.decode(response.body);
        print(
          'ApiService Error: Deleting item failed: ${response.statusCode} - ${errorBody['message']}',
        );
      ...
      throw Exception(
        'Network error or invalid response during delete item: $e',
      );
    }
  }
  ...
  Future<void> editItemInCategory(
    ...
    print(
      'ApiService: Editing item $itemId in category $categoryId for profile $profileId...',
    );
    final url = Uri.parse('${AppStrings.baseUrl}/imagewords/$itemId');
    ...
    if (newImageFile != null) {
      ...
      print(
        'ApiService: Editing item with new image file: ${newImageFile.path}',
      );
    } else {
      request.fields['imageUrl'] =
          currentImageUrl ??
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 204) {
        ...
        final errorBody = json.decode(response.body);
        print(
          'ApiService Error: Editing item failed: ${response.statusCode} - ${errorBody['message']}',
        );
  ...
  Future<ConjugationAndAudioResult> getAudioAndConjugate(
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        final errorBody = json.decode(response.body);
        print(
          'ApiService Error: Conjugation and audio failed: ${response.statusCode} - ${errorBody['message']}',
        );
        throw Exception(
          errorBody['message'] ?? 'Failed to conjugate and get audio',
        );
      }
      ...
      return ConjugationAndAudioResult(
        conjugatedWords: conjugatedItems,
        audioBase64: base64Audio,
      );
    } catch (e) {
      print('ApiService Exception during getAudioAndConjugate: $e');
      throw Exception(
        'Network error or invalid response during getAudioAndConjugate: $e',
      );
    }
  }
  ...
  Future<String> getAudio(List<CommunicationItem> words) async {
    ...
    try {
      ...
      request.headers['Authorization'] = 'Bearer $_authToken';
      request.body =
          '{"sentence": ${jsonEncode(words.map((x) => x.displayedWord).join(" "))}}';
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        final errorBody = json.decode(response.body);
        print(
          'ApiService Error: Audio failed: ${response.statusCode} - ${errorBody['message']}',
        );
  ...
  Future<String?> getRemotePin() async {
    final response = await http.get(
      Uri.parse('${AppStrings.baseUrl}/users/pin'),
  ...
  Future<bool> updateRemotePin(String newPin) async {
  ...
  Future<bool> sendResetPinEmail() async {
    final response = await http.post(
      Uri.parse('${AppStrings.baseUrl}/users/reset-pin-request'),
      headers: _getHeaders(includeAuth: true),
    );
    return response.statusCode == 200;
  }
